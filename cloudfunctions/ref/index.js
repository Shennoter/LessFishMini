const config = {
      appid: 'wx8f2c412b927daf89', //小程序Appid
      envName: 'lessfish-0gn8v8qe65d72e75', // 小程序云开发环境ID
      mchid: 'xxxxxxxxxxx1', //商户号
      partnerKey: 'xxxxxxxx', //服务商密钥
      pfx: '', //证书初始化
      fileID: 'xxxxxxxxxxxs', //证书云存储id
      actionName:'暨南大学二手书小程序提现',
